 ...
 * 
 * This module provides comprehensive diagram and chart creation capabilities for the PHS system.
 * It handles all visualization needs including time series plots, physiological data graphs,
 * and interactive diagrams for heat strain analysis.
 * 
 * Key Features:
 * - Time series plotting for physiological variables
 * - Interactive chart creation with zoom and pan
 ...
 * - Sweat rate plots
 * - Heart rate trends
 * - Environmental condition graphs
 * - Heat stress indices
 * 
 * Used for:
...
boj.diagram_util = (function () {
  ...
  // ============================================================================
// DEPENDENCIES AND DOM UTILITIES
// ============================================================================
...
/**
 * Deep clone function - creates complete copy of objects and arrays
 * Handles nested objects, arrays, and primitive values
 * @param {Object|Array} s - Source object or array to clone
 * @returns {Object|Array} Deep copy of the source
 * @throws {Error} If object type is not supported for cloning
 */
function clone_obj(s) {
  ...
  if (s instanceof Array) {
    // Handle arrays - create new array and recursively clone elements
    res = [];
    for (ik = 0; ik < s.length; ik++) {
      cur = s[ik];
      res[ik] = (cur === null || typeof cur !== "object") ? cur : clone_obj(cur);
    }
  } else if (s instanceof Object) {
    // Handle objects - create new object and recursively clone properties
    res = {};
    for (ik in s) {
      cur = s[ik];
      res[ik] = (cur === null || typeof cur !== "object") ? cur : clone_obj(cur);
